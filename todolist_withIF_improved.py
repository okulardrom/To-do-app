...
while True:
    ...
    elif 'complete'  in user_action: #methods for remove items from lists  clear() removes al items from the list, pop(index of item), remove(), exp: milist.remove('item to remove')
